...
| **`includeParentFolder`** | <code>boolean</code> | Whether to include the parent folder in the ZIP archive. When true (default), the source folder itself becomes the root directory in the archive. When false, only the contents of the source folder are included at the root level. This option only applies when the source is a directory. For single files, this option is ignored.                                                                                                                                                                                           | <code>true</code> | 8.1.0 |
